...
const DoctorCard = ({ data }) => {
    const { _id, name, designation, ratings, location, image } = data;
    return (
        <div className='border-2 p-4 rounded-md'>
            <img src={image} className='w-[324px] h-[200px] rounded-[10px]' alt="" />
            <div>
            ...
            <Link to={`/doctorsProfiles/${_id}`}><button className='btn btn-outline text-color w-full'>View Profile</button></Link>
        </div>
    );
};
