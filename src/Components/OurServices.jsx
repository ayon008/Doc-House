...
import img from '../assets/Rectangle 20078.png'
...
const OurServices = () => {
    ...
    return (
        <div className='lg:px-40 px-10 lg:my-20 my-10'>
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-8'>
                <img src={img} className='ms-auto w-auto h-[900px]' alt="" />
                <div className='space-y-6 max-w-[460px]'>
                    <h3 className='Source text-4xl font-semibold'>Our Services</h3>
                    <p className='text-sm'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inve ntore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                    <Tabs selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
                        <TabList className="tabs  tabs-boxed p-0">
                            <Tab className={`tab border-0 h-[60px] ${tabIndex === 0 && ' bg-btn'}`}>Cavity Protection</Tab>
                            <Tab className={`tab border-0 h-[60px] ${tabIndex === 1 && ' bg-btn'}`}>Cosmetic Dentisty</Tab>
                            <Tab className={`tab border-0 h-[60px] ${tabIndex === 2 && ' bg-btn'}`}>Oral Surgery</Tab>
                        </TabList>
                        <TabPanel>
                            <div className='space-y-6 mt-6'>
                                ...
                                <div className='text-center lg:text-left space-y-6'>
                                    ...
                                    <button className='btn btn-outline text-color'>More Details</button>
                                </div>
                            </div>
                        </TabPanel>
                        <TabPanel>
            ...
            <div className='grid md:grid-cols-3 grid-cols-1 gap-6 mt-8'>
                ...
                <div className='bg-green-900 flex items-start gap-5 p-6 rounded-lg'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                        <path d="M42.1875 7.8125V17.1875M42.1875 7.8125H32.8125M42.1875 7.8125L29.6875 20.3125M35.9375 45.3125C18.6792 45.3125 4.6875 31.3208 4.6875 14.0625V9.375C4.6875 8.1318 5.18136 6.93951 6.06044 6.06044C6.93951 5.18136 8.1318 4.6875 9.375 4.6875H12.2333C13.3083 4.6875 14.2458 5.41875 14.5062 6.4625L16.8104 15.6771C17.0396 16.5937 16.6979 17.5562 15.9417 18.1208L13.2479 20.1417C12.8624 20.4208 12.5771 20.8168 12.4345 21.2709C12.2918 21.7251 12.2995 22.2131 12.4562 22.6625C13.7102 26.0732 15.6904 29.1705 18.26 31.74C20.8295 34.3096 23.9268 36.2898 27.3375 37.5437C28.2562 37.8812 29.2708 37.5354 29.8583 36.7521L31.8792 34.0583C32.1558 33.6891 32.5352 33.4097 32.9699 33.2551C33.4046 33.1006 33.8753 33.0778 34.3229 33.1896L43.5375 35.4938C44.5792 35.7542 45.3125 36.6917 45.3125 37.7667V40.625C45.3125 41.8682 44.8186 43.0605 43.9396 43.9396C43.0605 44.8186 41.8682 45.3125 40.625 45.3125H35.9375V45.3125Z" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <div className='text-white'>
                        <h3 className='text-lg font-semibold'>Contact Us</h3>
                        <p className='text-sm'>+88 01750 00 00 00 <br />
                            +88 01750 00 00 00</p>
                    </div>
                </div>
            </div>
