...
import img2 from '../assets/Rectangle 15 (1).png'
import img3 from '../assets/Rectangle 15 (2).png';
    ...
    return (
        <div className='lg:px-40 px-10 mb-20 w-fit mx-auto grid lg:grid-cols-3 grid-cols-1 gap-6'>
            <div className='border-2 p-4 rounded-md'>
                <img src={img1} alt="" />
                <div>
                    <div className='space-y-2 mt-2 border-b-2 pb-6'>
                        <h3 className='font-bold text-lg'>Karyen Anderson</h3>
                        <p className='card-text'>BTP -  Senior Physiotherapist</p>
                        <div className='flex'>
